...
**NOTE**: Plugins are Python files that run with full access to your computer every time the app starts. Only install plugins from sources you trust; Picasso shows a one-time warning before the first install.

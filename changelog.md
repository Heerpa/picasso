...
- Multichannel spline PSF fitting (GPUfit's `SPLINE_3D_MULTICHANNEL`, e.g. biplane); additionally a new model was added for uncoupled photons (biplane). The global (multichannel) fitting follows globLoc, see [Li, et al, Nature Communications, 2022](https://doi.org/10.1038/s41467-022-30719-4)
